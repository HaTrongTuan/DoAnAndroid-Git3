...
public class GiangVienDataBase extends SQLiteOpenHelper {
    ...
    public static final String COL_GV_ID = "G_Id";
    public static final String COL_GV_NAME = "G_Name";
    public static final String COL_GV_BIRTH = "G_Birth";
    public static final String COL_GV_GENDER = "G_Gender";
    public static final String COL_GV_PHONE = "G_Phone";
    public static final String COL_GV_ACHIEVEMENT = "G_Achievement";
    public static final String COL_GV_COMMENT = "G_Comment";
    public static final String COL_GV_PHOTO = "G_Photo";
